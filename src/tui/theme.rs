...
impl Face {
    pub const ALL: &'static [Face] = &[
        ...
        Face::Toast,
        Face::PastePreview,
        Face::PastePreviewMute,
        Face::PastePreviewHint,
        Face::HintBar,
        Face::HintKey,
        Face::HintSep,
        Face::HintLabel,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Face::ComposeChip => "compose.chip",
            Face::ComposeBorder => "compose.border",
            Face::Select => "select",
            Face::Toast => "toast",
            Face::PastePreview => "paste.preview",
            Face::PastePreviewMute => "paste.preview.mute",
            Face::PastePreviewHint => "paste.preview.hint",
            ...
            Face::StatusBar => "status.bar",
            Face::StatusSep => "status.sep",
            Face::StatusGit => "status.git",
            Face::PickerField => "picker.field",
            Face::PickerHit => "picker.hit",
            Face::PickerHitActive => "picker.hit.active",
            Face::Menu => "menu",
            Face::MenuActive => "menu.active",
            Face::MenuBorder => "menu.border",
            Face::MenuTitle => "menu.title",
            Face::MenuKey => "menu.key",
            ...
            Face::ScrollTrack => "scroll.track",
            Face::ScrollThumb => "scroll.thumb",
            Face::RailDotPlot => "rail.dot.plot",
            Face::PlotSpark => "plot.spark",
            Face::PlotMute => "plot.mute",
            Face::PlotPrefill => "plot.prefill",
            Face::PlotThink => "plot.think",
            Face::PlotDecode => "plot.decode",
            Face::PlotTool => "plot.tool",
            Face::PlotStat => "plot.stat",
            Face::PlotGauge => "plot.gauge",
            Face::PlotGaugeWarn => "plot.gauge.warn",
            Face::PlotGaugeHot => "plot.gauge.hot",
        }
    }
...
fn default_faces() -> BTreeMap<Face, FaceSpec> {
    ...
    [
        ...
        (ComposePrompt, f(Ink::Accent, Ink::Raised)),
        (ComposeInput, f(Ink::Ink, Ink::Raised)),
        (ComposeChip, f(Ink::Ink, Ink::Raised)),
        (ComposeBorder, f(Ink::OnAccent, Ink::Accent)),
        (Select, f(Ink::OnAccent, Ink::Accent)),
        (Toast, b(Ink::OnAccent, Ink::Accent)),
        (PastePreview, f(Ink::Ink, Ink::Raised)),
        (PastePreviewMute, f(Ink::Mute, Ink::Raised)),
        (PastePreviewHint, f(Ink::Info, Ink::Raised)),
        ...
        (StatusBar, f(Ink::Mute, Ink::Inset)),
        (StatusSep, f(Ink::Faint, Ink::Inset)),
        (StatusGit, f(Ink::Good, Ink::Inset)),
        (PickerField, f(Ink::Ink, Ink::Inset)),
        (PickerHit, f(Ink::Ink, Ink::Inset)),
        (PickerHitActive, f(Ink::Ink, Ink::Raised)),
        (Menu, f(Ink::Ink, Ink::Raised)),
        (MenuActive, f(Ink::OnAccent, Ink::Accent)),
        (MenuBorder, f(Ink::Accent, Ink::Raised)),
        (MenuTitle, f(Ink::Accent, Ink::Raised)),
        (MenuKey, f(Ink::Mute, Ink::Raised)),
        ...
        (ScrollTrack, f(Ink::Overlay, Ink::Canvas)),
        (ScrollThumb, f(Ink::Accent, Ink::Canvas)),
        (RailDotPlot, f(Ink::Peach, Ink::Canvas)),
        (PlotSpark, f(Ink::Info, Ink::Canvas)),
        (PlotMute, f(Ink::Mute, Ink::Canvas)),
        (PlotPrefill, f(Ink::Info, Ink::Canvas)),
        (PlotThink, f(Ink::Peach, Ink::Canvas)),
        (PlotDecode, f(Ink::Good, Ink::Canvas)),
        (PlotTool, f(Ink::Accent, Ink::Canvas)),
        (PlotStat, b(Ink::Ink, Ink::Canvas)),
        (PlotGauge, f(Ink::Good, Ink::Canvas)),
        (PlotGaugeWarn, f(Ink::Warn, Ink::Canvas)),
        (PlotGaugeHot, f(Ink::Bad, Ink::Canvas)),
    ]
    .into_iter()
    .collect()
}
